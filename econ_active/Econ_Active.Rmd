...
econ_active %>%
  ...
  theme_minimal() +
  labs(title = "Economically Active Population | Korea 2020 - 2021", 
...
employed %>%
  ...
  geom_bar(position = "dodge", stat = "identity") +
  theme_minimal() +
  labs(title = "Employed Population | Korea 2020 - 2021", 
       x = "Month", y = "Population (thousands)") + 
  theme(plot.title = element_text(face = "bold"),
        axis.title.x = element_text(face = "bold"),
        axis.title.y = element_text(face = "bold"),
...
unemployed %>%
  ...
  geom_bar(position = "dodge", stat = "identity") +
  theme_minimal() +
  labs(title = "Unemployed Population | Korea 2020 - 2021", 
       x = "Month", y = "Population (thousands)") + 
  theme(plot.title = element_text(face = "bold"),
        axis.title.x = element_text(face = "bold"),
        axis.title.y = element_text(face = "bold"),
